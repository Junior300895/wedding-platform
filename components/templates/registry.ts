...
export const themes: Record<string, Theme> = {
  classic: {
    ...
    accentDot: "bg-[#5f4f3e]",
    field: "bg-[#faf7f2] border-[#e0d5c2] text-[#2b2723] placeholder:text-[#b0a08d]",
    heroFont: "font-serif",
  ...
  minimal: {
    ...
    field: "bg-white border-neutral-300 text-neutral-900 placeholder:text-neutral-400",
    heroFont: "font-sans",
  ...
  luxury: {
    ...
    accentDot: "bg-[#d4af37]",
    field:
      "bg-[#1e1b17] border-[#d4af37]/30 text-[#f2efe9] placeholder:text-[#8a7d60] [color-scheme:dark]",
    heroFont: "font-serif",
  ...
  floral: {
    ...
    accentDot: "bg-[#c02466]",
    field: "bg-[#fef6f8] border-[#f0cad6] text-[#3b2a30] placeholder:text-[#c98aa6]",
    heroFont: "font-serif",
  ...
  tradition: {
    ...
    accentDot: "bg-[#a0522d]",
    field: "bg-[#fbf3e9] border-[#ddc4a2] text-[#4a2c1a] placeholder:text-[#b08d68]",
    heroFont: "font-serif",
  ...
  oriental: {
    ...
    accentDot: "bg-[#0f6b4f]",
    field: "bg-[#f4f8f6] border-[#bcd8cb] text-[#0f3d2e] placeholder:text-[#6ba38d]",
    heroFont: "font-serif",
